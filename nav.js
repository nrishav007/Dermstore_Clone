...
<div id="navbar2">
    <div>
        ...
        <div>
            <a href="#" style="color:black; text-decoration: none"><i class="fa fa-fw fa-user"></i> <div class="dropdown">
                ...
                <div class="dropdown-content" style="width:300px ; height:auto ; line-height: 30px;justify-content: center;">
                    <a href="#" style="width: 83%; height:20px ;text-align: center; align-items: center;background-color: black;" ><b style="color: aliceblue; ">Login</b></a>
                    <a href="#"  style="width: 83%; height:20px ;text-align: center; align-items: center; background-color: rgb(236, 234, 234);border:solid black;margin-top: 5px;" ><b style="color: black; ">Rigester</a>
        ...
        <div>
            <a href="#" style='font-size:25px; color:black; text-decoration: none;'><i class='fas fa-shopping-cart'
